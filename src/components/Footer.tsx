const Footer = () => {
  return (
    <footer className="animate-down-top">
      <div className="my-section bg-tertiary text-white lg:flex grid grid-cols-1 overflow-hidden">
        <div className="w-full space-y-1 text-primary">
          ...
          <div className="text-sm my-footer-info-content">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-1 text-secondary lg:block hidden"
        ...
        <div className="w-full lg:justify-start justify-center">
          <nav className="my-footer-nav-content">
            <a
              title="Sistema Bancario | Home"
              href="/"
              className="my-footer-nav-button"
            >
              Início
            </a>
            <a
              title="Sistema Bancario | Cliente"
              href="/account"
              className="my-footer-nav-button"
            >
              Cliente
            ...
            <a
              title="Sistema Bancario | Administrador"
              href="/admin"
              className="my-footer-nav-button"
            >
              Administrador
          ...
          <div className="my-footer-social-content">
            <a
              aria-label="Acessar Facebook"
              href="https://facebook.com/"
              title="Facebook"
              className="my-footer-social-button"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
      ...
      <div className="min-w-[400px] md:px-52 px-12 bg-quarter text-secondary">
